...
project = u'Pitch Angle Synchrotron Model'
...
rtds_action_github_repo = "grburgess/pypa_synch"
...
latex_documents = [
    (master_doc, 'pypa_synch.tex', u'Pitch Angle Synchrotron Model Documentation',
...
man_pages = [(master_doc, 'pypa_synch', u'Pitch Angle Synchrotron Model Documentation', [author], 1)]
...
texinfo_documents = [
    (master_doc, 'pypa_synch', u'Pitch Angle Synchrotron Model Documentation', author, 'pypa_synch',
